...
const ProductForm = ({ editProduct, token }) => {
  ...
  const [pokedex, setPokedex] = useState(
    editProduct ? editProduct.pokedexId : 0
  );
  const [firstType, setFirstType] = useState(
    editProduct ? editProduct.type1 : ""
  );
  const [secondType, setSecondType] = useState(
    editProduct ? editProduct.type2 : ""
  );
    ...
    <div className="container">
      <form className="user-forms" onSubmit={handleAddProduct}>
        ...
        <input
          ...
          required
          type="text"
          placeholder="Pokemon Pokedex"
          value={pokedex}
          onChange={(event) => setPokedex(event.target.value)}
        />
        ...
        <input
          ...
          required
          type="text"
          placeholder="Pokemon first type"
          value={firstType}
          onChange={(event) => setFirstType(event.target.value)}
        />
        <label>Secondary type:</label>
        <input
          className="text-input"
          type="text"
          placeholder="Pokemon second type"
          value={secondType}
          onChange={(event) => setSecondType(event.target.value)}
        />
        <label>Cost:</label>
        <input
          className="text-input"
        ...
        <input
          required
          type="text"
          placeholder="Card quanitity to sell"
          value={quantity}
